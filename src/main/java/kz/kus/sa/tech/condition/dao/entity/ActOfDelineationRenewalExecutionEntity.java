...
@Table(name = "act_of_delineation_renewal_executions", schema = Constants.SCHEMA_NAME)
@TypeDef(name = "list-array", typeClass = ListArrayType.class)
@TypeDef(name = "jsonb",typeClass = JsonBinaryType.class)
public class ActOfDelineationRenewalExecutionEntity extends AbstractAuditingEntity {
