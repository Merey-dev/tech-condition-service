...
public class TechConditionEntity extends AbstractAuditingEntity {
    ...
    @OneToMany(mappedBy = "techCondition", cascade = CascadeType.ALL, orphanRemoval = true)
    @ToString.Exclude
    private List<kz.kus.sa.tech.condition.dao.entity.IntersectionEntity> intersections;
    ...
    @OneToMany(mappedBy = "techCondition", cascade = CascadeType.ALL, orphanRemoval = true)
    @ToString.Exclude
    private List<kz.kus.sa.tech.condition.dao.entity.TechConditionMaximumLoadEntity> maximumLoads;
    ...
    @OneToMany(mappedBy = "techCondition", cascade = CascadeType.ALL, orphanRemoval = true)
    @ToString.Exclude
    private List<kz.kus.sa.tech.condition.dao.entity.TechConditionPlannedEquipmentEntity> plannedEquipments;
    ...
    @OneToMany(mappedBy = "techCondition", cascade = CascadeType.ALL, orphanRemoval = true)
    @ToString.Exclude
    private List<kz.kus.sa.tech.condition.dao.entity.TechConditionReliabilityCategoryEntity> reliabilityCategories;
