...
@Mapper(componentModel = "spring", uses = {
        ...
        kz.kus.sa.tech.condition.dao.mapper.TechConditionMaximumLoadMapper.class,
        kz.kus.sa.tech.condition.dao.mapper.TechConditionSubConsumerMapper.class,
        kz.kus.sa.tech.condition.dao.mapper.TechConditionPlannedEquipmentMapper.class,
        kz.kus.sa.tech.condition.dao.mapper.TechConditionReliabilityCategoryMapper.class,
        kz.kus.sa.tech.condition.dao.mapper.TechConditionContractualCapacityOfTransformerMapper.class,
},
...
public abstract class TechConditionMapper {
    ...
    @Autowired
    private kz.kus.sa.tech.condition.dao.mapper.IntersectionMapper intersectionMapper;
    @Autowired
    private IntersectionService intersectionService;
    @Autowired
    private kz.kus.sa.tech.condition.dao.mapper.TechConditionSubConsumerMapper subConsumerMapper;
    @Autowired
    private TechConditionSubConsumerService subConsumerService;
    @Autowired
    private kz.kus.sa.tech.condition.dao.mapper.TechConditionMaximumLoadMapper maximumLoadMapper;
    @Autowired
    private TechConditionMaximumLoadService maximumLoadService;
    @Autowired
    private kz.kus.sa.tech.condition.dao.mapper.TechConditionPlannedEquipmentMapper plannedEquipmentMapper;
    @Autowired
    private TechConditionPlannedEquipmentService plannedEquipmentService;
    @Autowired
    private kz.kus.sa.tech.condition.dao.mapper.TechConditionReliabilityCategoryMapper reliabilityCategoryMapper;
    @Autowired
    private TechConditionReliabilityCategoryService reliabilityCategoryService;
    @Autowired
    private kz.kus.sa.tech.condition.dao.mapper.TechConditionContractualCapacityOfTransformerMapper contractualCapacityOfTransformerMapper;
    @Autowired
