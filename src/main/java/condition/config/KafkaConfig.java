package condition.config;

import kz.kus.sa.tech.condition.config.TechConditionConfiguration;
...
public class KafkaConfig {
    ...
    private final kz.kus.sa.tech.condition.config.TechConditionConfiguration.KafkaConfiguration kafkaConfiguration;
