...
import kz.kus.sa.tech.condition.statemachine.base.Action;
import kz.kus.sa.tech.condition.statemachine.base.EventRule;
import kz.kus.sa.tech.condition.statemachine.base.Guard;
...
public abstract class StateConfig<S, E, O, OE> {
    private Map<S, Map<E, kz.kus.sa.tech.condition.statemachine.base.EventRule<S, E, O, OE>>> stateMap = new HashMap();
    ...
    public final O changeState(O entity, OE execution, S state, E event) throws UnknownStateException, UnknownEventException, GuardException {
        if (!this.stateMap.containsKey(state)) {
            ...
            Map<E, kz.kus.sa.tech.condition.statemachine.base.EventRule<S, E, O, OE>> eventMap = this.stateMap.get(state);
            if (!eventMap.containsKey(event)) {
                throw new UnknownEventException("Unknown event");
            } else {
                kz.kus.sa.tech.condition.statemachine.base.EventRule<S, E, O, OE> eventRule = eventMap.get(event);
    ...
    public final Map<E, kz.kus.sa.tech.condition.statemachine.base.EventRule<S, E, O, OE>> getActions(S state) {
    ...
    public static class EventRuleBuilder<S, E, O, OE> {
        ...
        private kz.kus.sa.tech.condition.statemachine.base.EventRule<S, E, O, OE> actionRule;

        public EventRuleBuilder(EventBuilder<S, E, O, OE> eventBuilder, kz.kus.sa.tech.condition.statemachine.base.EventRule<S, E, O, OE> actionRule, E event) {
        ...
        public EventRuleBuilder<S, E, O, OE> action(kz.kus.sa.tech.condition.statemachine.base.Action<O, OE, S, E>... action) {
    ...
    public static class EventBuilder<S, E, O, OE> {
        private Map<E, kz.kus.sa.tech.condition.statemachine.base.EventRule<S, E, O, OE>> eventMap;

        public EventBuilder(Map<E, kz.kus.sa.tech.condition.statemachine.base.EventRule<S, E, O, OE>> eventMap) {
            this.eventMap = eventMap;
        }

        public EventRuleBuilder<S, E, O, OE> event(E event) {
            this.eventMap.put(event, new kz.kus.sa.tech.condition.statemachine.base.EventRule());
            return new EventRuleBuilder(this, this.eventMap.get(event), event);
        }
    }

    public static class StateBuilder<S, E, O, OE> {
        private Map<S, Map<E, kz.kus.sa.tech.condition.statemachine.base.EventRule<S, E, O, OE>>> stateMap;
