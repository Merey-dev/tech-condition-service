...
public class AbdAddressEntity extends kz.kus.sa.tech.condition.dao.entity.AbstractAuditingEntity {
    ...
    private kz.kus.sa.tech.condition.dao.entity.TechConditionExecutionEntity techConditionExecution;

    @OneToMany(mappedBy = "objectAbdAddress", fetch = FetchType.LAZY)
    private List<kz.kus.sa.tech.condition.dao.entity.TechConditionExecutionAbdAddressDecisionEntity> executionDecisions;
    ...
    private kz.kus.sa.tech.condition.dao.entity.ActOfDelineationRenewalEntity actOfDelineationRenewal;
    ...
    private kz.kus.sa.tech.condition.dao.entity.ActOfDelineationEntity actOfDelineation;
}
