...
@Component
@AllArgsConstructor
public class TechConditionEpoStatemachine  extends StateConfig<String, Event, TechConditionEntity, TechConditionExecutionEntity> {
...
//                .action(this::setState);
    ...
    private boolean isExecutor(TechConditionEntity entity) {
        ...
        log.info("TECH CONDITION EPO statemachine user id = [{}], isExecutor = [{}], assignees = [{}]",
    ...
    private boolean isMainExecutor(TechConditionEntity entity) {
        ...
        log.info("TECH CONDITION EPO statemachine user id = [{}], isMainExecutor = [{}], executor = [{}]",
    ...
    private boolean isInitiator(TechConditionEntity entity) {
        ...
        log.info("TECH CONDITION EPO statemachine user id = [{}], isInitiator = [{}], initiator = [{}]",
